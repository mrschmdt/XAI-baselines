...
def train_model(
    ...
    train_accuracy = torchmetrics.Accuracy(task="binary",average="macro")
    test_accuracy = torchmetrics.Accuracy(task="binary",average="macro")
    test_accuracy_per_class = torchmetrics.Accuracy(task="binary",average=None)
